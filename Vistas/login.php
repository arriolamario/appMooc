<?php
	include_once $_SERVER['DOCUMENT_ROOT'] . '/appMooc/CapaLogica/indexController.php';
	...
	<script type="text/javascript">
      $(document).ready(function() {
		...
		$('a').click(function(e) {
			...
			$('#container').load(href); // Esta línea simplemente carga el contenido dentro del div 'contenido'
			});
      });    
    </script>
</head>
